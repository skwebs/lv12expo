    ...
    <body
        ...
        <div
            ...
            <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                <div
                    class="flex-1 rounded-bl-lg rounded-br-lg bg-white p-6 pb-12 text-[13px] leading-5 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-br-none lg:rounded-tl-lg lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                ...
                <div
                    ...
                    {{-- Light Mode 12 SVG --}}
                    <svg class="w-md relative -ml-8 -mt-[4.9rem] max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:hidden"
                    ...
                    {{-- Dark Mode 12 SVG --}}
                    <svg class="w-md relative -ml-8 -mt-[4.9rem] hidden max-w-none lg:-mt-[6.6rem] lg:ml-0 dark:block"
                        viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g
                            class="duration-750 starting:opacity-0 starting:translate-y-4 translate-y-0 opacity-100 transition-all delay-300">
                            <path
